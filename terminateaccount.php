...
session_start(); 
        ...
        $conn= new mysqli($servername, $username, $password,$dbname);
         ...
         die("Connection failed: " . $conn->connect_error);
	           ...
	           $sql ="select * from customer_account where status='Terminated'";
			 ...
			 <hr>
			  <a href="logout.php" class="text-dark"><i class="fa fa-power-off"></i> logout</a>
				        ...
				        <!-- sidebar ends-->
						 ...
						 <h4><span ><a href="dashboard.php"><i class="fa fa-home i-items"></i> <span class="hidden-menu">Home</span></a></span>&nbsp &nbsp<span ><a href="account.php"><i class="fa fa-users i-items"></i> <span class="hidden-menu">Accounts</span></a></span>&nbsp &nbsp<i class="fa fa-ban i-items"></i> <span class="hidden-menu">Terminated Accounts</span></h4>
						 </div>
						 
						 <div class="container-fluid mt-3">
						 
						 <div class="account-request col-12">
						 <h3 class="text-center">All Terminated Accounts</h3>
						 </div>
