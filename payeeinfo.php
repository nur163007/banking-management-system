			...
			while($res = mysqli_fetch_array($result)){  
			  ?>
	                    ...
	                    ?>
						 ...
						 <div class="col-lg-8 col-12 contentoption" id="info">
						     <div class="container-fluid mt-3">
						 
						 <div class="account-request-payee col-12">
						 <h2 class="text-left text-danger">All Payee Information</h2>
						 </div>
						 <!--account details part start -->
						 <input type="text" name="" class="form-control"id="myInput" onkeyup="searchFunction()"placeholder="Search by Account Number">
...
if ($conn->connect_error) {
    die("Connection failed: " . $conn->connect_error);
	  ...
	  $sql ="select * from payee where phone_no=$token";
...
?>	
				...
				<td> <?php echo $user['payee_name'];?></td>
				<td> <?php echo $user['payee_account_no'];?></td>
				<td> <?php echo $user['remark'];?></td>
				<td><a href="payeeedit.php?payee_account_no=<?php echo $user['payee_account_no'];?>&&phone_no=<?php echo $_SESSION['phone_no'];?>&&serial_no=<?php echo $user['serial_no'];?>"class="text-success"style="text-decoration:none;font-size:20px;"><i class="fa fa-edit text-success fa-2x"> </i></a></td>
				<td><a href="payeedelete.php?payee_account_no=<?php echo $user['payee_account_no'];?>&&phone_no=<?php echo $_SESSION['phone_no'];?>&&serial_no=<?php echo $user['serial_no'];?>"class="text-success"style="text-decoration:none;font-size:20px;"><i class="fa fa-user-times text-danger fa-2x"> </i></a></td>
