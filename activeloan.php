			 ...
			 <hr>
			  <a href="logout.php" class="text-dark"><i class="fa fa-power-off"></i> logout</a>
				        ...
				        <!-- sidebar ends-->
						 ...
						 <h4><span ><a href="dashboard.php"><i class="fa fa-home i-items"></i> <span class="hidden-menu">Home</span></a></span>&nbsp &nbsp<span ><a href="loan.php"><i class="fa fa-database i-items"></i> <span class="hidden-menu">Loan</span></a></span>&nbsp &nbsp<i class="fa fa-list i-items"></i> <span class="hidden-menu">Active Loan</span></h4>
						 </div>
						 
						 <div class="container-fluid mt-3">
						 
						 <div class="account-request col-12">
						 <h3 class="text-center">All Loan Request</h3>
						 </div>
						 <!--account details part start -->
						  <input type="text" name="" class="form-input"id="myInput" onkeyup="searchFunction()"placeholder="Search by Name">
			   ...
			   <tr class="text-center bg-white">
				...
				<td> <img src="phpimage/<?php echo $user['appli_file'];?>"style="width:80px;height:85px;"></td>
				<td> <?php echo $user['customer_name'];?></td>
				<td> <?php echo $user['loan_type'];?></td>
				<td> <?php echo $user['term'];?></td>
				<td> <?php echo $user['amount'];?></td>
				<td> <?php echo $user['status'];?></td>
				<td><a href="viewactiveloan.php?account_no=<?php echo $user['account_no'];?>&&serial_no=<?php echo $user['serial_no'];?>"class="text-success"style="text-decoration:none;font-size:20px;"><i class="fa fa-edit text-success fa-2x"> </i></a></td>
