...
session_start(); 
        ...
        $conn= new mysqli($servername, $username, $password,$dbname);
         ...
         die("Connection failed: " . $conn->connect_error);
	           ...
	           $sql ="select * from customer_fund where remark2='withdrawl'";
			 ...
			 <hr>
			  <a href="logout.php" class="text-dark"><i class="fa fa-power-off"></i> logout</a>
			   ...
			   <tr class="text-center bg-white">
				...
				<td> <?php echo $user['withdrawl'];?></td>
				<td><a href="viewwithdraw.php?account_no=<?php echo $user['account_no'];?>"class="text-success"style="text-decoration:none;font-size:20px;"><i class="fa fa-edit text-success fa-2x"> </i></a></td>
