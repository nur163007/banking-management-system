...
session_start(); 
        ...
        $conn= new mysqli($servername, $username, $password,$dbname);
         ...
         die("Connection failed: " . $conn->connect_error);
		   ...
		   $sql ="select count(account_no) AS total from card";
		   $result =mysqli_query($conn,$sql);
		   $values = mysqli_fetch_assoc($result);
		   $output =$values['total'];
		  
		   $pending ="select count(account_no) AS total from card where status='Pending'";
			  ...
			  <a href="logout.php" class="text-dark"><i class="fa fa-power-off"></i> logout</a>
				        ...
				        <!-- sidebar ends-->
						 ...
						 <div class="dashboard_home">
						  <h4><span ><a href="dashboard.php"><i class="fa fa-home i-items"></i> <span class="hidden-menu">Home</span></a></span>&nbsp &nbsp<i class="fa fa-credit-card i-items"></i> <span class="hidden-menu">Card</span></h4>
						 </div>
						...
						<h6>Card Request</h6>
						 ...
						 <h6><a href="checkcard.php"class="text-primary">View Details <i class="fa fa-arrow-circle-right"></i></a></h6>
						 </div>
						 </div>
						 </div>
						...
						<h6>All Cards</h6>
						 ...
						 <div class="card-footer bg-white">
						 <h6><a href="cardstatement.php"class="text-success">View Details <i class="fa fa-arrow-circle-right"></i></a></h6>
						 </div>
						 </div>
						 </div>
