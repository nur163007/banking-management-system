...
$update = "UPDATE customer_account SET status = 'Terminated' WHERE account_no = '$accountno'";
...
$mail->Subject = 'Account Termination message';
$mail->Body    = "<h3><b>Banking Management Sysetm</b><br> Your account is Terminated.<br>You can't apply for create account again.<br><br><br><br> Thank you.</h3>";
