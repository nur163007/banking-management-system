			 ...
			 <hr>
			  <a href="logout.php" class="text-dark"><i class="fa fa-power-off"></i> logout</a>
				        ...
				        <!-- sidebar ends-->
						 ...
						 <h4><span ><a href="dashboard.php"><i class="fa fa-home i-items"></i> <span class="hidden-menu">Home</span></a></span>&nbsp &nbsp<span ><a href="checktransection.php"><i class="fa fa-rocket i-items"></i> <span class="hidden-menu">Transection</span></a>&nbsp &nbsp<span ><a href="checkwithdraw.php"><i class="fa fa-user-plus i-items"></i> <span class="hidden-menu"> Withdraw list</span></a></span>&nbsp &nbsp<i class="fa fa-list i-items"></i> <span class="hidden-menu">Withdrawl Details</span></h4>
						 </div>
...
?>	
				...
				<td><span class="tableleft col-lg-5 col-5"><i class="fa fa-edit"></i> Status</span><span class="tableright col-lg-7 col-7">: <?php echo $row['status'];?></span></td>
             	...
             	?>
						 ...
						 <div class="account-details col-12">
						 <h2 class="text-left text-success">Withdrawl Information</h2>
						 </div>
						 <div class="aaccount-account col-lg-12 col-12 mt-4 table-responsive">
						 <table class="table table-striped">
						 <?php
...
?>	
 <tbody class="table-bordered ">
				...
				<td>
				<a href="withdrawupdate.php?account_no=<?php echo $row['account_no'];?>"class="text-success col-12"><i class="fa fa-check-square-o text-success"> </i> Accepted</a>
				<a href="checkwithdraw.php"class="text-danger col-12"><i class="fa fa-arrow-left text-danger"> </i> Back</a>
				</td>
