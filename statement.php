			...
			while($output = mysqli_fetch_array($result)){  
			  ?>
	                    ...
	                    ?>
						 ...
						 <div class="col-lg-8 col-12 contentoption" id="statement">
						     <div class="container-fluid mt-3">
						 
						 <div class="account-request-payee col-12">
						 <h2 class="text-left text-danger">Transection History</h2>
						 </div>
...
if ($conn->connect_error) {
    die("Connection failed: " . $conn->connect_error);
	  ...
	  $sql ="select * from transection where phone_no = '$phoneno'";
...
?>
				...
				<td> <?php echo $res['transection_id'];?></td>
				...
				<td> <?php echo $res['transfer'];?></td>
				<td> <?php echo $res['withdrawl'];?></td>
				<td><a href="deletetransection.php?transection_id=<?php echo $res['transection_id'];?>&&phone_no=<?php echo $res['phone_no'];?>"class="text-success"style="text-decoration:none;font-size:20px;"><i class="fa fa-trash text-danger fa-2x"> </i></a></td>
				</tr>
