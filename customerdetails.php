			 ...
			 <hr>
			  <a href="logout.php" class="text-dark"><i class="fa fa-power-off"></i> logout</a>
				        ...
				        <!-- sidebar ends-->
						 ...
						 <h4><span ><a href="dashboard.php"><i class="fa fa-home i-items"></i> <span class="hidden-menu">Home</span></a></span>&nbsp &nbsp<span ><a href="account.php"><i class="fa fa-users i-items"></i> <span class="hidden-menu">Accounts</span></a>&nbsp &nbsp<span ><a href="accountrequest.php"><i class="fa fa-user-plus i-items"></i> <span class="hidden-menu">New Account Request</span></a></span>&nbsp &nbsp<i class="fa fa-list i-items"></i> <span class="hidden-menu">Account Details</span></h4>
						 </div>
...
?>	
				...
				<td>
				<a href="customerupdate.php?account_no=<?php echo $row['account_no'];?>"class="text-success col-12"><i class="fa fa-check-square-o text-success"> </i>Approved</a>
				<a href="customerreject.php?account_no=<?php echo $row['account_no'];?>"class="text-danger col-12"><i class="fa fa-user-times text-danger"> </i>Rejected</a>
				<a href="customerterminate.php?account_no=<?php echo $row['account_no'];?>"class="text-danger col-12"><i class="fa fa-ban text-danger"> </i>Terminated</a>
				</td>
