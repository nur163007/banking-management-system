			 ...
			 <hr>
			  <a href="logout.php" class="text-dark"><i class="fa fa-power-off"></i> logout</a>
				        ...
				        <!-- sidebar ends-->
						 ...
						 <h4><span ><a href="dashboard.php"><i class="fa fa-home i-items"></i> <span class="hidden-menu">Home</span></a></span>&nbsp &nbsp<span ><a href="checktransection.php"><i class="fa fa-rocket i-items"></i> <span class="hidden-menu">Transection</span></a>&nbsp &nbsp<span ><a href="checkdeposit.php"><i class="fa fa-user-plus i-items"></i> <span class="hidden-menu"> Deposit list</span></a></span>&nbsp &nbsp<i class="fa fa-list i-items"></i> <span class="hidden-menu">Deposit Details</span></h4>
						 </div>
						 
						 <div class="container-fluid mt-3">
						 
						 <div class="account-details col-12">
						 <h2 class="text-left text-success">Personal details</h2>
						 </div>
...
?>	
				...
				<td><span class="tableleft col-lg-5 col-5"><i class="fa fa-edit"></i> Status</span><span class="tableright col-lg-7 col-7">: <?php echo $row['status'];?></span></td>
             	...
             	?>
						 ...
						 <div class="account-details col-12">
						 <h2 class="text-left text-success">Deposit Information</h2>
						 </div>
						 <div class="aaccount-account col-lg-12 col-12 mt-4 table-responsive">
						 <table class="table table-striped">
						 <?php
...
if ($conn->connect_error) {
    die("Connection failed: " . $conn->connect_error);
	  ...
	  $accountno=$_GET['account_no'];
	  $sql ="select * from customer_fund where account_no=$accountno";
	  $query_run= mysqli_query($conn,$sql);
      while($row = mysqli_fetch_array($query_run)) {
...
?>	
 <tbody class="table-bordered ">
				...
				<tr class="text-left bg-white">
				<td><span class="tableleft col-lg-5 col-5"><i class="fa fa-keyboard-o"></i> Transection No</span><span class="tableright col-lg-7 col-7">: <?php echo $row['transection_no'];?></span></td>
				</tr>
				...
				<tr class="text-left bg-white">
				<td><span class="tableleft col-lg-5 col-5"><i class="fa fa-user-o"></i> Branch Name</span><span class="tableright col-lg-7 col-7">: <?php echo $row['branch'];?></span></td>
				</tr>
				...
				<tr class="text-left bg-white">
				<td><span class="tableleft col-lg-5 col-5"><i class="fa fa-vcard"></i> Account Type</span><span class="tableright col-lg-7 col-7">: <?php echo $row['account_type'];?></span></td>
				</tr>
				
				<tr class="text-left bg-white">
				<td><span class="tableleft col-lg-5 col-5"><i class="fa fa-list"></i> Term</span><span class="tableright col-lg-7 col-7">: <?php echo $row['term'];?></span></td>
				</tr>
				...
				<tr class="text-left bg-white">
				<td><span class="tableleft col-lg-5 col-5"><i class="fa fa-check-square-o"></i> Status</span><span class="tableright col-lg-7 col-7">: <?php echo $row['deposit'];?></span></td>
				</tr>
				
			    <tr class="text-left bg-white detailsbutton">
				<td>
				<a href="depositupdate.php?account_no=<?php echo $row['account_no'];?>"class="text-success col-12"><i class="fa fa-check-square-o text-success"> </i> Accepted</a>
				<a href="checkdeposit.php"class="text-danger col-12"><i class="fa fa-arrow-left text-danger"> </i> Back</a>
				</td>
