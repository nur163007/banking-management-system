			 ...
			 <hr>
			  <a href="logout.php" class="text-dark"><i class="fa fa-power-off"></i> logout</a>
				        ...
				        <!-- sidebar ends-->
						 ...
						 <h3 class="text-center">All Card Information</h3>
						 </div>
			   ...
			   <tr class="text-center bg-white">
				...
				<td><a href="allcard.php?s_no=<?php echo $user['s_no'];?>"class="text-success"style="text-decoration:none;font-size:20px;"><i class="fa fa-edit text-success fa-2x"> </i></a></td>
