...
if ($conn->connect_error) {
    die("Connection failed: " . $conn->connect_error);
	  ...
	  $slno=$_GET['serial_no'];
	  $sql ="select * from loan where account_no='$accountno' and serial_no='$slno'";
...
if ($conn->connect_error) {
    die("Connection failed: " . $conn->connect_error);
	  ...
	  $accountno=$_GET['account_no'];
	  $sql ="select * from loan where account_no=$accountno";
	  $query_run= mysqli_query($conn,$sql);
      while($row = mysqli_fetch_array($query_run)) {
...
?>	
               <tbody class="table-bordered ">
				...
				<tr class="text-left bg-white">
				<td><span class="tableleft col-lg-5 col-5"><i class="fa fa-percentage"></i> Interest rate</span><span class="tableright col-lg-7 col-7">: <?php echo $res['interest_rate'].'%';?></span></td>
				</tr>
...
?>	
			    ...
			    <tr class="text-left bg-white detailsbutton">
				<td><span class="tableleft">
				<a href="adminloanactivation.php?serial_no=<?php echo $row['serial_no'];?>&&phone_no=<?php echo $row['phone_no'];?>"class="text-success col-12"><i class="fa fa-check-square-o text-success"></i> Approved</a>
				<a href="adminloanreject.php?serial_no=<?php echo $row['serial_no'];?>&&phone_no=<?php echo $row['phone_no'];?>"class="text-danger col-12"><i class="fa fa-trash text-danger"></i> Rejected</a>
				<a href="loanrequest.php"class="text-success col-12"><i class="fa fa-arrow-left text-success"></i> Back</a>
				</td>
