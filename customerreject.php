...
$update = "UPDATE customer_account SET status = 'Rejected' WHERE account_no = '$accountno'";
...
$mail->Subject = 'Account Rejection message';
$mail->Body    = "<h3><b>Banking Management Sysetm</b><br> Your account is Rejected.<br>You can't login to your account.Apply again for openting account with valid information<br><br><br><br> Thank you.</h3>";
