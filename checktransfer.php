...
session_start(); 
        ...
        $conn= new mysqli($servername, $username, $password,$dbname);
         ...
         die("Connection failed: " . $conn->connect_error);
	           ...
	           $sql ="select * from customer_fund where remark1='transfer'";
			 ...
			 <hr>
			  <a href="logout.php" class="text-dark"><i class="fa fa-power-off"></i> logout</a>
			   ...
			   <tr class="text-center bg-white">
				<td> <?php echo $user['transection_no'];?></td>
				<td> <?php echo $user['customer_name'];?></td>
				<td> <?php echo $user['account_type'];?></td>
				<td> <?php echo $user['remark1'];?></td>
				<td> <?php echo $user['amount'];?></td>
				<td> <?php echo $user['transfer'];?></td>
				<td><a href="viewtransfer.php?account_no=<?php echo $user['account_no'];?>"class="text-success"style="text-decoration:none;font-size:20px;"><i class="fa fa-edit text-success fa-2x"> </i></a></td>
