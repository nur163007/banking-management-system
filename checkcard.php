...
session_start(); 
        ...
        $conn= new mysqli($servername, $username, $password,$dbname);
         ...
         die("Connection failed: " . $conn->connect_error);
	           ...
	           $sql ="select * from card where status='Pending'";
			 ...
			 <hr>
			  <a href="logout.php" class="text-dark"><i class="fa fa-power-off"></i> logout</a>
				        ...
				        <!-- sidebar ends-->
						 ...
						 <h4><span ><a href="dashboard.php"><i class="fa fa-home i-items"></i> <span class="hidden-menu">Home</span></a></span>&nbsp &nbsp<span ><a href="card.php"><i class="fa fa-vcard-o i-items"></i> <span class="hidden-menu">Card</span></a></span>&nbsp &nbsp<i class="fa fa-list i-items"></i> <span class="hidden-menu">Card List</span></h4>
						 </div>
						 
						 <div class="container-fluid mt-3">
						 
						 <div class="account-request col-12">
						 <h3 class="text-center">All Card Request</h3>
						 </div>
						 <!--account details part start -->
						 <input type="text" name="" class="form-input"id="myInput" onkeyup="searchFunction()"placeholder="Search by Card number">
			   ...
			   <tr class="text-center bg-white">
				...
				<td> <?php echo '$'.$user['card_limit'];?></td>
				<td> <?php echo $user['apply_date'];?></td>
				<td> <?php echo $user['status'];?></td>
				<td><a href="viewcard.php?s_no=<?php echo $user['s_no'];?>"class="text-success"style="text-decoration:none;font-size:20px;"><i class="fa fa-edit text-success fa-2x"> </i></a></td>
